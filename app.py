...
OLD_MODEL_PATH = os.getenv("OLD_TFLITE_PATH", os.path.join(BASE_DIR, "OLD_STGCN.tflite"))
NEW_MODEL_PATH = os.getenv("NEW_TFLITE_PATH", os.path.join(BASE_DIR, "NEW_STGCN.tflite"))
